...
const animations = {
  loading: {
    ...
    layers: [{
      ...
      ks: {
        o: { a: 1, k: [{ t: 0, s: [100] }, { t: 30, s: [25] }, { t: 60, s: [100] }], ix: 11 },
      ...
      shapes: [
        ...
        { ty: 'st', c: { a: 0, k: [0, 0.831, 1, 1] }, o: { a: 0, k: 100 }, w: { a: 0, k: 3 }, lc: 2, lj: 1 },
        { ty: 'tm', s: { a: 1, k: [{ t: 0, s: [0] }, { t: 45, s: [75] }, { t: 60, s: [95] }], ix: 1 }, e: { a: 1, k: [{ t: 0, s: [5] }, { t: 30, s: [85] }, { t: 60, s: [100] }], ix: 2 }, o: { a: 0, k: 0 }, m: 1 }
      ],
      ip: 0, op: 61, st: 0
    }]
  },
  ...
  empty: {
    v: '5.5.2', fr: 30, ip: 0, op: 90, w: 200, h: 200, nm: 'Empty', ddd: 0, assets: [],
    layers: [{
      ddd: 0, ind: 1, ty: 4, nm: 'icon', sr: 1,
      ks: {
        o: { a: 1, k: [{ t: 0, s: [0] }, { t: 15, s: [100] }], ix: 11 },
        r: { a: 0, k: 0, ix: 10 },
        p: { a: 0, k: [100, 100, 0], ix: 2 },
        a: { a: 0, k: [0, 0, 0], ix: 1 },
        s: { a: 1, k: [{ t: 0, s: [70, 70, 100] }, { t: 20, s: [105, 105, 100] }, { t: 30, s: [95, 95, 100] }, { t: 45, s: [100, 100, 100] }], ix: 6 }
      },
      shapes: [
        { ty: 'rc', p: { a: 0, k: [0, -8] }, s: { a: 0, k: [36, 28] }, r: { a: 0, k: 8 } },
        { ty: 'st', c: { a: 0, k: [0, 0.831, 1, 1] }, o: { a: 0, k: 80 }, w: { a: 0, k: 2.5 }, lc: 1, lj: 1, d: [{ n: 'd', nm: 'dash', v: { a: 0, k: 8 } }] },
  ...
  uploading: {
    v: '5.5.2', fr: 30, ip: 0, op: 60, w: 24, h: 24, nm: 'Upload', ddd: 0, assets: [],
    layers: [{
      ...
      shapes: [
        ...
        { ty: 'st', c: { a: 0, k: [1, 1, 1, 1] }, o: { a: 0, k: 100 }, w: { a: 0, k: 2.5 }, lc: 2, lj: 1 },
        { ty: 'tm', s: { a: 1, k: [{ t: 0, s: [0] }, { t: 60, s: [80] }], ix: 1 }, e: { a: 1, k: [{ t: 0, s: [10] }, { t: 35, s: [95] }, { t: 60, s: [100] }], ix: 2 }, o: { a: 0, k: 0 }, m: 1 }
      ],
      ip: 0, op: 61, st: 0
    }]
  }
